...
CLuaArgument::CLuaArgument(const char* szString) : m_iType(LUA_TSTRING) {
    assert(szString);
...
CLuaArgument::~CLuaArgument() { if (m_szString) delete[] m_szString; }
...
int CLuaArgument::GetType() const noexcept { return m_iType; };

bool CLuaArgument::GetBoolean() const noexcept { return m_bBoolean; };
lua_Number CLuaArgument::GetNumber() const noexcept { return m_Number; };
const char* CLuaArgument::GetString() const noexcept { return m_szString; };
void* CLuaArgument::GetLightUserData() const noexcept { return m_pLightUserData; };
lua_CFunction CLuaArgument::GetFunction() const noexcept { return m_Function; }