...
#include "SharedUtil.Misc.h"
 ...
 // Format a string
 //
inline SString& SString::vFormat(const char* szFormat, va_list vl)
{
#ifdef _WIN32
...
//
inline void SString::OnFormatException(const char* szFormat)
{
    dassert(0);
...
//
inline void SString::OnInvalidParameter(const char* szFormat)
{
    dassert(0);
    // Replace format characters because it seems like a good idea
...
// Split into parts
//
inline void SString::Split(const SString& strDelim, std::vector<SString>& outResult, unsigned int uiMaxAmount, unsigned int uiMinAmount) const
{
    outResult.clear();
...
//
inline bool SString::Split(const SString& strDelim, SString* pstrLeft, SString* pstrRight, int iIndex) const
{
...
//
inline SString SString::SplitLeft(const SString& strDelim, SString* pstrRight, int iIndex) const
{
    SString strLeft;
...
//
inline SString SString::SplitRight(const SString& strDelim, SString* pstrLeft, int iIndex) const
{
    SString strRight;
...
//
inline SString SString::Replace(const char* szOld, const char* szNew, bool bSearchJustReplaced) const
{
...
//
inline SString SString::ReplaceI(const char* szOld, const char* szNew, bool bSearchJustReplaced) const
{
...
//
inline SString SString::TrimStart(const char* szOld) const
{
...
//
inline SString SString::TrimEnd(const char* szOld) const
{
    const size_t uiOldLength = strlen(szOld);
    SString      strResult = *this;
...
//
inline SString SString::ConformLineEndings() const
{
    assert('\n' == '\x0A');
...
//
inline bool SString::Contains(const SString& strOther) const
{
...
//
inline bool SString::ContainsI(const SString& strOther) const
{
...
//
inline bool SString::CompareI(const SString& strOther) const
{
    return _stricmp(*this, strOther) == 0;
}

// Fault tolerant version of substr
inline SString SString::SubStr(int iPos, int iCount) const
{
    if (iPos < 0)
    {
        iCount += iPos;
...
inline SString SString::Left(int iCount) const
{
    return SubStr(0, iCount);
}

// Right most number of characters
inline SString SString::Right(int iCount) const
{
    return SubStr((int)length() - iCount, iCount);
}

inline bool SString::EndsWith(const SString& strOther) const
{
    return Right((int)strOther.length()) == strOther;
}

inline bool SString::EndsWithI(const SString& strOther) const
{
    return _stricmp(Right((int)strOther.length()), strOther) == 0;
}

inline bool SString::BeginsWith(const SString& strOther) const
{
    return Left((int)strOther.length()) == strOther;
}

inline bool SString::BeginsWithI(const SString& strOther) const
{
    return _stricmp(Left((int)strOther.length()), strOther) == 0;
}

// Static function
inline SString SString::Join(const SString& strDelim, const std::vector<SString>& parts, int iFirst, int iCount)
{
    SString strResult;
...
inline void SString::AssignLeft(const char* szOther, uint uiMaxLength)
{
